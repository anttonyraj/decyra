...
// Comprehensive world languages ordered by global speakers with English as default
export const ALL_WORLD_LANGUAGES: LanguageOption[] = [
  ...
  { code: "zh", name: "Chinese", native: "中文 (Mandarin Chinese)", dir: "ltr", speechCode: "zh-CN", placeholder: "询问有关您数据的任何问题..." },
  ...
  { code: "pt", name: "Portuguese", native: "Português (Portuguese)", dir: "ltr", speechCode: "pt-BR", placeholder: "Pergunte qualquer coisa sobre seus dados..." },
